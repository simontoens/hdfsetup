...
def augment_c_dir(c_dir_adf, destdir):
    command_list = ["type", "dir", "cd", "echo", "assign", "info", "execute"]
...
if __name__ == "__main__":
    ...
    with temp_dir() as tempdir:
        ...
        startSeqBuilder.comment("Generated by hdfsetup on %s/%s/%s" % (now.month, now.day, now.year))        
